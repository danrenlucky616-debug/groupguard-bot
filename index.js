...
async function createWhatsAppSession(
  ...
  sock.ev.on(
    ...
    async update => {
      ...
      if (
        ...
        // Do not create duplicate reconnects.
        if (
  ...
  try {
    ...
    throw new Error(
      'WhatsApp rejected the pairing request. Try again with the number in international format, without +.'
    )
  }
}
